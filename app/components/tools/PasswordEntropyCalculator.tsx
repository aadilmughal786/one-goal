  ...
  return (
    <div className="p-6 rounded-lg bg-bg-secondary text-text-primary">
            ...
            <div className="p-6 rounded-lg border bg-bg-primary border-border-primary">
              ...
              <div className="space-y-3 text-md">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono truncate">{formatBigInt(analysis.combinations)}</span>
                </div>
              </div>
            </div>
      ...
      <div className="p-6 mt-8 rounded-lg border bg-bg-primary border-border-primary">
        <h3 className="mb-3 text-xl font-semibold text-text-primary">What is Password Entropy?</h3>
        <div className="space-y-3 text-text-secondary">
          <p>
            Password entropy is a measure of how unpredictable a password is. It&apos;s measured in
            bits, and a higher bit value means a stronger, more secure password that is
            exponentially harder to guess or crack.
          </p>
          <p>The calculation uses the formula:</p>
          <div className="p-3 my-1 text-lg text-center rounded-md bg-bg-secondary">
            {isClient && <BlockMath math={String.raw`E = L \times \log_2(N)`} />}
          </div>
